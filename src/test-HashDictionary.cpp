 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test probe() hashing helper function", "[task1]")
{
 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test hash() hashing helper function, table size 7", "[task1]")
{
 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test hash() hashing helper function, table size 31", "[task1]")
{
 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test probeForAvailableSlot() helper function", "[task2]")
{
  // test hashing on hash table of size 7
  const int HASH_TABLE_SIZE = 7;
  HashDictionary<int, Employee> dict(HASH_TABLE_SIZE);
 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test probeForKeySlot() helper function", "[task2]")
{
  // test hashing on hash table of size 7
  const int HASH_TABLE_SIZE = 7;
  HashDictionary<int, Employee> dict(HASH_TABLE_SIZE);
 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test insert() API member function", "[task3]")
{
  const int HASH_TABLE_SIZE = 7;
  HashDictionary<int, Employee> dict(HASH_TABLE_SIZE);
  CHECK(dict.getSize() == 0);
 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test find() API member function", "[task4]")
{
 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test remove() API member function", "[task5]")
{
 ...
 */
/**/
TEST_CASE("HashDictionaryNode<int, Employee> test remove() MISSING values handled correctly", "[task5]")
{
  // (re)create dictionary we used when testing insert/find
  const int HASH_TABLE_SIZE = 7;
  HashDictionary<int, Employee> dict(HASH_TABLE_SIZE);
